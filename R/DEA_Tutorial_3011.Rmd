...
Analysis of differentially expressed genes between cells infected with GFP (controls) and WT TP63-KLF4 (treatment).
The number of replicates in this study are:
...
kable(data.frame(Filtering=c("Before","After"),Genes=c(nrow(counts),nrow(dge$counts))))
